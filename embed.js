...
var __Ashby = {
    ...
    buildIFrameUrl: function (settings) {
    ...
    log: function (_a) {
        var message = _a.message, _b = _a.verboseOnly, verboseOnly = _b === void 0 ? true : _b;
        if (verboseOnly && window.__Ashby.settings.verboseLogging === true) {
    ...
    handleIncomingMessage: function (e) {
        ...
        if (container && iframe && e.data) {
            ...
            if (data === "apply_for_job_tapped" ||
                ...
                (_a = iframe.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage("jid_reset", "*");
            }
                ...
                if (!container.getAttribute("data-jid")) {
                    ...
                    (_b = iframe.contentWindow) === null || _b === void 0 ? void 0 : _b.postMessage("jid_set=".concat(jobId), "*");
                }
                if (window.__Ashby.settings.autoScroll) {
                    container.scrollIntoView(true);
                }
                ...
                iframe.setAttribute("height", 3400);
            }
        }
    },
    iFrame: function () {
        return {
            ...
            load: function (settingsOverrides) {
                ...
                iframe.setAttribute("src", window.__Ashby.buildIFrameUrl(settings));
...
//# debugId=b320a902-6e58-5c90-a788-5edbbb157c74
